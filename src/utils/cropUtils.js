// /**
//  * Utility functions for the Tomato Crop Yield Prediction Dashboard
//  */

// /**
//  * Generate recommendations based on comparing current sensor data with the target plan
//  * 
//  * @param {Object} currentDayPlan - The plan data for the current day
//  * @param {Object} liveData - Live sensor data from Firebase
//  * @returns {Array} - Array of recommendation objects
//  */
// export const generateRecommendations = (currentDayPlan, liveData) => {
...
// /**
//  * Parse CSV data into usable format (placeholder for actual CSV parsing)
//  * In a real implementation, this would use Papa Parse or similar to process the CSV file
//  * 
//  * @returns {Object} - Object containing parsed data and metadata
//  */
// export const parseCSVData = () => {
//     // Only tomato as specified
//     const cropTypes = ["Tomato"];
...
//     const generateData = () => {
//         const data = [];
//         for (let day = 1; day <= 120; day++) { // Days 1-90 as specified
//             for (const crop of cropTypes) {
//                 for (const landType of landTypes) {
//                     // Determine growth stage based on day
//                     let growthStage;
...
//                     // Generate random but realistic values for each parameter
//                     // Values differ based on land type to reflect different growing conditions
